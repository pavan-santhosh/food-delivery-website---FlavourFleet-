...
import {ReactComponent as DeliveryBoy} from "../images/delivery-boy.svg";
...
function Home()
{
  ...
  const handleMouseOver = () => {
    ...
    <body>
        <div id="hero">
            {navbar()}
            <img id="bg2" src={require("../images/hero-bg-shape.png")} alt="Restaurants"></img>
            <img id="bg4" src={require("../images/hero-banner-bg.png")} alt="Restaurants"></img>
            <img id="bg3" src={require("../images/hero-banner.png")} alt="Restaurants"></img>
            <div id="caption">
        ...
        <div class="d-flex flex-row flex-nowrap">
            <div class="card">
                <div class="card-body">
                    <img src={require("../images/promo-icon-1.png")} alt=""></img><br></br><br></br>
                ...
                <img src={require("../images/promo1.png")} style={{width:'90%'}} alt="..."></img>
            </div>
            <div class="card">
                <div class="card-body">
                    <img src={require("../images/promo-icon-2.png")} alt=""></img><br></br><br></br>
                ...
                <img src={require("../images/promo2.png")} style={{width:'70%'}} alt="..."></img>
            </div>
            <div class="card">
                <div class="card-body">
                    <img src={require("../images/promo-icon-3.png")} alt=""></img><br></br><br></br>
                ...
                <img src={require("../images/promo3.png")} style={{width:'100%'}} alt="..."></img>
            </div>
            <div class="card">
                <div class="card-body">
                    <img src={require("../images/promo-icon-4.png")} alt=""></img><br></br><br></br>
                ...
                <img src={require("../images/promo4.png")} style={{width:'85%'}} alt="..."></img>
            </div>
            <div class="card">
                <div class="card-body">
                    <img src={require("../images/promo-icon-5.png")} alt=""></img><br></br><br></br>
                ...
                <img src={require("../images/promo5.png")} style={{width:'70%'}} alt="..."></img>
            </div>
        </div>
        </div>
        </div>
        ...
        <figure class="image">
          <img id="pic1" src={require("../images/cta-banner.png")}></img>
          <img id="pic2" src={require("../images/sale-shape-red.png")}></img>
        </figure>
        </div>
        <section>
        <div id="delivery"
        ...
        <div id="footer">
            <div id="cont">
            <a href="" class="logo">FlavourFleet<span class="span">.</span></a>
